...
enabling automatic generation of database migrations.
"""
...
def get_engine():
    ...
    try:
        # this works with Flask-SQLAlchemy<3 and target_db="default"
...
def get_metadata():
    """Get the metadata from the Flask-SQLAlchemy instance."""
